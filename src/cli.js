...
const struct = {
  ...
  skills: ['coding', 'knowledges'],
};

const commands = {};
let systemData = {};
const rootPath = 'users/rilcode/root';
...
$(() => {
  ...
  pages.push($.get('pages/knowledges.html'));
  pages.push($.get('pages/help.html'));
  pages.push($.get('pages/coding.html'));
  ...
  $.when
    ...
    .done(
      (
        ...
        systemData['knowledges'] = knowledgesData[0];
        systemData['help'] = helpData[0];
        systemData['coding'] = codingData[0];
